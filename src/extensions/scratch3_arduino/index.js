...
const ArduinoConnectionState = ['Connected', 'Disconnected'];
//const ArduinoAnalogOut = ['3', '5', '6'];
const ArduinoBoolValues = ['Active', 'Disactive'];
...
const ArduinoServos = ['Servo1', 'Servo2'];
...
const ArduinoDirections = ['Left', 'Right'];
			...
			blocks: [
				...
				*/
				
				{
					...
					blockType: BlockType.BOOLEAN,
					text: 'Button[DIGITAL_IN]=[BOOL_VAL]',
				...
				*/
...

				{
					...
					blockType: BlockType.COMMAND,
					text: 'Import[RGB_CH][RGB_N]a[COLOR_VAL]',
					arguments: {
						RGB_CH: {
							type: ArgumentType.STRING,
							menu: 'mRGBch',
				...
				},
				{
					...
					blockType: BlockType.COMMAND,
					text: 'Setting [RGB_CH][RGB_N]di[VAL]',
					arguments: {
						RGB_CH: {
							type: ArgumentType.STRING,
							menu: 'mRGBch',
